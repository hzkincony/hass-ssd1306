# 8x8 font bitmap data, 90 degree transposed for SSD1306 GDDRAM
# Index corresponds to ASCII code (0-127)
# Each glyph is 8 bytes, each byte represents a column (LSB = top row)
